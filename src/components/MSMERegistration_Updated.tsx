...
//   []
// );
const schema = useMemo(() => createRegistrationSchema(), [isEditing]);

const resolver = yupResolver<MSMERegistrationForm>(schema);
...
const {
  ...
  shouldFocusError: true, // 👈 Makes the invalid field show automatically
});
