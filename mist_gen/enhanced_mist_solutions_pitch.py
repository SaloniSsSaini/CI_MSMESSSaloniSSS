#!/usr/bin/env python3
"""
Enhanced script to create a refined 5-slide pitch presentation about mist solutions for air and water borne infections
Designed for IdeaOne Hackathon 2024 - Professional look and feel with enhanced visuals and graphics
"""
...
def create_enhanced_mist_solutions_pitch():
    ...
    # Slide 1: The Problem - Enhanced with visual elements
    ...
    # Top accent bar
    accent_bar = slide1.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0), Inches(0), Inches(13.33), Inches(0.3))
    accent_bar.fill.solid()
    accent_bar.fill.fore_color.rgb = primary_blue
    
    # Warning icon circle
    warning_circle = slide1.shapes.add_shape(MSO_SHAPE.OVAL, Inches(5.5), Inches(1.2), Inches(2.5), Inches(2.5))
    warning_circle.fill.solid()
    warning_circle.fill.fore_color.rgb = warning_red
    warning_circle.line.fill.background()
    
    # Main title
    title_box = slide1.shapes.add_textbox(Inches(0.5), Inches(1.5), Inches(12.33), Inches(1))
    ...
    # Subtitle
    subtitle_box = slide1.shapes.add_textbox(Inches(0.5), Inches(2.7), Inches(12.33), Inches(0.8))
    ...
    # Statistics with visual boxes
    # Stat box 1
    stat1_box = slide1.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(3.8), Inches(3), Inches(1.5))
    stat1_box.fill.solid()
    stat1_box.fill.fore_color.rgb = light_blue
    stat1_box.line.color.rgb = primary_blue
    stat1_box.line.width = Pt(2)
    
    stat1_text = slide1.shapes.add_textbox(Inches(0.6), Inches(4.1), Inches(2.8), Inches(0.9))
    stat1_frame = stat1_text.text_frame
    stat1_p = stat1_frame.paragraphs[0]
    stat1_p.text = "3.2 MILLION\nDEATHS ANNUALLY"
    stat1_p.font.size = Pt(18)
    stat1_p.font.bold = True
    stat1_p.font.color.rgb = primary_blue
    stat1_p.alignment = PP_ALIGN.CENTER
    
    # Stat box 2
    stat2_box = slide1.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(3.8), Inches(3.8), Inches(3), Inches(1.5))
    stat2_box.fill.solid()
    stat2_box.fill.fore_color.rgb = light_green
    stat2_box.line.color.rgb = secondary_green
    stat2_box.line.width = Pt(2)
    
    stat2_text = slide1.shapes.add_textbox(Inches(3.9), Inches(4.1), Inches(2.8), Inches(0.9))
    stat2_frame = stat2_text.text_frame
    stat2_p = stat2_frame.paragraphs[0]
    stat2_p.text = "$1.2 TRILLION\nHEALTHCARE COSTS"
    stat2_p.font.size = Pt(18)
    stat2_p.font.bold = True
    stat2_p.font.color.rgb = secondary_green
    stat2_p.alignment = PP_ALIGN.CENTER
    
    # Stat box 3
    stat3_box = slide1.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(7.1), Inches(3.8), Inches(3), Inches(1.5))
    ...
    stat3_box.line.width = Pt(2)
    
    stat3_text = slide1.shapes.add_textbox(Inches(7.2), Inches(4.1), Inches(2.8), Inches(0.9))
    stat3_frame = stat3_text.text_frame
    stat3_p = stat3_frame.paragraphs[0]
    stat3_p.text = "90% GLOBAL\nPOPULATION AFFECTED"
    stat3_p.font.size = Pt(18)
    stat3_p.font.bold = True
    stat3_p.font.color.rgb = accent_orange
    stat3_p.alignment = PP_ALIGN.CENTER
    
    # Stat box 4
    stat4_box = slide1.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(10.4), Inches(3.8), Inches(2.5), Inches(1.5))
    stat4_box.fill.solid()
    stat4_box.fill.fore_color.rgb = RGBColor(255, 182, 193)  # Light pink
    stat4_box.line.color.rgb = warning_red
    stat4_box.line.width = Pt(2)
    
    stat4_text = slide1.shapes.add_textbox(Inches(10.5), Inches(4.1), Inches(2.3), Inches(0.9))
    stat4_frame = stat4_text.text_frame
    stat4_p = stat4_frame.paragraphs[0]
    stat4_p.text = "15-20%\nLIVESTOCK MORTALITY"
    stat4_p.font.size = Pt(16)
    ...
    # Top accent bar
    accent_bar2 = slide2.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0), Inches(0), Inches(13.33), Inches(0.3))
    ...
    # Technology icon
    tech_circle = slide2.shapes.add_shape(MSO_SHAPE.OVAL, Inches(5.5), Inches(3), Inches(2.5), Inches(2.5))
    tech_circle.fill.solid()
    tech_circle.fill.fore_color.rgb = secondary_green
    tech_circle.line.fill.background()
    
    tech_text = slide2.shapes.add_textbox(Inches(5.6), Inches(3.8), Inches(2.3), Inches(0.9))
    tech_frame = tech_text.text_frame
    tech_p = tech_frame.paragraphs[0]
    tech_p.text = "MIST\nTECH"
    tech_p.font.size = Pt(24)
    tech_p.font.bold = True
    tech_p.font.color.rgb = RGBColor(255, 255, 255)
    tech_p.alignment = PP_ALIGN.CENTER
    
    # Key features in columns with visual boxes
    # Left column
    left_box = slide2.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(5.8), Inches(6), Inches(1.2))
    left_box.fill.solid()
    left_box.fill.fore_color.rgb = light_blue
    left_box.line.color.rgb = primary_blue
    left_box.line.width = Pt(2)
    
    left_text = slide2.shapes.add_textbox(Inches(0.6), Inches(6), Inches(5.8), Inches(0.8))
    ...
    # Right column
    right_box = slide2.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(6.5), Inches(5.8), Inches(6), Inches(1.2))
    right_box.fill.solid()
    right_box.fill.fore_color.rgb = light_green
    right_box.line.color.rgb = secondary_green
    right_box.line.width = Pt(2)
    
    right_text = slide2.shapes.add_textbox(Inches(6.6), Inches(6), Inches(5.8), Inches(0.8))
    ...
    # Top accent bar
    accent_bar3 = slide3.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0), Inches(0), Inches(13.33), Inches(0.3))
    ...
    # Air disinfection section with visual box
    air_box = slide3.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(2.2), Inches(6), Inches(3.5))
    air_box.fill.solid()
    air_box.fill.fore_color.rgb = light_blue
    air_box.line.color.rgb = primary_blue
    air_box.line.width = Pt(3)
    ...
    air_title_p.font.size = Pt(20)
    air_title_p.font.bold = True
    air_title_p.font.color.rgb = primary_blue
    air_title_p.alignment = PP_ALIGN.CENTER
    
    air_content = slide3.shapes.add_textbox(Inches(0.6), Inches(3.1), Inches(5.8), Inches(2.4))
...
✓ Real-time quality monitoring"""
    ...
    # Water disinfection section with visual box
    water_box = slide3.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(6.5), Inches(2.2), Inches(6), Inches(3.5))
    water_box.fill.solid()
    water_box.fill.fore_color.rgb = light_green
    water_box.line.color.rgb = secondary_green
    water_box.line.width = Pt(3)
    ...
    water_title_p.font.size = Pt(20)
    water_title_p.font.bold = True
    water_title_p.font.color.rgb = secondary_green
    water_title_p.alignment = PP_ALIGN.CENTER
    
    water_content = slide3.shapes.add_textbox(Inches(6.6), Inches(3.1), Inches(5.8), Inches(2.4))
...
✓ Post-treatment filtration"""
    ...
    innovation_box = slide3.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(1), Inches(6), Inches(11.33), Inches(1))
    ...
    innovation_box.line.width = Pt(3)
    
    innovation_text = slide3.shapes.add_textbox(Inches(1.1), Inches(6.2), Inches(11.13), Inches(0.6))
    ...
    # Top accent bar
    accent_bar4 = slide4.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0), Inches(0), Inches(13.33), Inches(0.3))
    ...
    market_box = slide4.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(1), Inches(2), Inches(11.33), Inches(1.2))
    ...
    market_box.line.width = Pt(4)
    
    market_text = slide4.shapes.add_textbox(Inches(1.1), Inches(2.3), Inches(11.13), Inches(0.6))
    market_frame = market_text.text_frame
    market_p = market_frame.paragraphs[0]
    market_p.text = "💰 TOTAL ADDRESSABLE MARKET: $32.4 BILLION"
    market_p.font.size = Pt(28)
    market_p.font.bold = True
    market_p.font.color.rgb = accent_orange
    market_p.alignment = PP_ALIGN.CENTER
    
    # Applications grid with visual boxes
    # Healthcare sector
    health_box = slide4.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(3.5), Inches(6), Inches(2.5))
    health_box.fill.solid()
    health_box.fill.fore_color.rgb = light_blue
    health_box.line.color.rgb = primary_blue
    health_box.line.width = Pt(2)
    
    health_title = slide4.shapes.add_textbox(Inches(0.6), Inches(3.7), Inches(5.8), Inches(0.4))
    ...
    health_title_p.font.size = Pt(18)
    health_title_p.font.bold = True
    health_title_p.font.color.rgb = primary_blue
    health_title_p.alignment = PP_ALIGN.CENTER
    
    health_content = slide4.shapes.add_textbox(Inches(0.6), Inches(4.2), Inches(5.8), Inches(1.6))
...
• 85% reduction in infections"""
    ...
    # Agricultural sector
    agri_box = slide4.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(6.5), Inches(3.5), Inches(6), Inches(2.5))
    agri_box.fill.solid()
    agri_box.fill.fore_color.rgb = light_green
    agri_box.line.color.rgb = secondary_green
    agri_box.line.width = Pt(2)
    
    agri_title = slide4.shapes.add_textbox(Inches(6.6), Inches(3.7), Inches(5.8), Inches(0.4))
    agri_title_frame = agri_title.text_frame
    agri_title_p = agri_title_frame.paragraphs[0]
    agri_title_p.text = "🏭 AGRICULTURAL SECTOR"
    agri_title_p.font.size = Pt(18)
    agri_title_p.font.bold = True
    agri_title_p.font.color.rgb = secondary_green
    agri_title_p.alignment = PP_ALIGN.CENTER
    
    agri_content = slide4.shapes.add_textbox(Inches(6.6), Inches(4.2), Inches(5.8), Inches(1.6))
...
• 40% reduction in costs"""
    ...
    # Key metrics box
    metrics_box = slide4.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(1), Inches(6.2), Inches(11.33), Inches(0.8))
    ...
    metrics_text = slide4.shapes.add_textbox(Inches(1.1), Inches(6.4), Inches(11.13), Inches(0.4))
    metrics_frame = metrics_text.text_frame
    metrics_p = metrics_frame.paragraphs[0]
    metrics_p.text = "KEY METRICS: 70% decrease in respiratory illness | 60% decrease in animal mortality | 25% increase in production efficiency"
    ...
    # Top accent bar
    accent_bar5 = slide5.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(0), Inches(0), Inches(13.33), Inches(0.3))
    ...
    # Value proposition
    value_box = slide5.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(1), Inches(2), Inches(11.33), Inches(0.8))
    ...
    value_box.line.width = Pt(3)
    
    value_text = slide5.shapes.add_textbox(Inches(1.1), Inches(2.2), Inches(11.13), Inches(0.4))
    ...
    partner_box = slide5.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(3.2), Inches(6), Inches(3))
    partner_box.fill.solid()
    partner_box.fill.fore_color.rgb = light_blue
    partner_box.line.color.rgb = primary_blue
    partner_box.line.width = Pt(2)
    
    partner_title = slide5.shapes.add_textbox(Inches(0.6), Inches(3.4), Inches(5.8), Inches(0.4))
    ...
    partner_title_p.font.size = Pt(18)
    partner_title_p.font.bold = True
    partner_title_p.font.color.rgb = primary_blue
    partner_title_p.alignment = PP_ALIGN.CENTER
    
    partner_content = slide5.shapes.add_textbox(Inches(0.6), Inches(3.9), Inches(5.8), Inches(2.1))
...
• Experienced team & advisors"""
    ...
    # Next steps
    steps_box = slide5.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(6.5), Inches(3.2), Inches(6), Inches(3))
    steps_box.fill.solid()
    steps_box.fill.fore_color.rgb = light_green
    steps_box.line.color.rgb = secondary_green
    steps_box.line.width = Pt(2)
    
    steps_title = slide5.shapes.add_textbox(Inches(6.6), Inches(3.4), Inches(5.8), Inches(0.4))
    ...
    steps_title_p.font.size = Pt(18)
    steps_title_p.font.bold = True
    steps_title_p.font.color.rgb = secondary_green
    steps_title_p.alignment = PP_ALIGN.CENTER
    
    steps_content = slide5.shapes.add_textbox(Inches(6.6), Inches(3.9), Inches(5.8), Inches(2.1))
...
Website: www.misthealth.com"""
    ...
    impact_box = slide5.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(1), Inches(6.5), Inches(11.33), Inches(0.8))
    ...
    impact_text = slide5.shapes.add_textbox(Inches(1.1), Inches(6.7), Inches(11.13), Inches(0.4))
    ...
    output_path = "/workspace/mist_gen/enhanced_mist_solutions_pitch.pptx"
    prs.save(output_path)
    print(f"Enhanced PowerPoint presentation created successfully: {output_path}")
    
    return output_path

if __name__ == "__main__":
    create_enhanced_mist_solutions_pitch()